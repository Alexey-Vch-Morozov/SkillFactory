...
def notify_subscribers(sender, instance, created, **kwargs):
    if created:
        ...
        category = Category.objects.get(pk=4) #Почему-то не проходит запрос по ПостКатегори - Пост создается,
        # записывается в базу, но не записывается в таблицу ПостКатегори.
